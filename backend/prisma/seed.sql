-- =============================================
-- SEED DATA - MediCRM (Version avec guillemets doubles)
...
('o4', 'p4', 'm2', 'k1', NOW() - INTERVAL '1 day', 8, 'Tendinite épaule', 'Maternité', 'FIN_DE_TRAITEMENT', NOW(), NOW()),
('o5', 'p1', 'm1', 'k1', NOW(), 6, 'Suivi post-entorse', 'Classique', 'SUIVI_PREVENTIF', NOW(), NOW());
...
('s1', 'o1', 'k1', NOW() + INTERVAL '2 days', 'PREVU', 'Bilan initial', 'AMK 9', 9.0, NOW(), NOW());